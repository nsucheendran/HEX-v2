...
public class GenericUDAFFirstValueNValueSort extends
	...
	private static class MinOrderedSet implements AggregationBuffer {
		...
		private boolean areNewSortKeysLesser(Object[] newKeys,
			...
			int compareResult = ObjectInspectorUtils.compare(newKeys,
					sortKeyOI, sortKeys, sortKeyOI);
			if (compareResult < 0) {
				return true;
			}
			return false;
		...
		public ObjectInspector init(Mode m, ObjectInspector[] parameters)
			...
			if (m == Mode.PARTIAL1) {
				...
				return ObjectInspectorUtils
						.getWritableObjectInspector(ObjectInspectorFactory
		...
		public void merge(AggregationBuffer agg, Object partial)
			...
			if (partial != null) {
				...
				for (Map.Entry<Object, Object> data : partialData.entrySet()) {
					...
					Object newVal = ObjectInspectorUtils.copyToStandardObject(
							data.getKey(), writableValueOI);
