...
/**
 * GenericUDFPattern. 1. Array to be worked on 2. Pattern to be applied to each
 * array element 3. Replace pattern 4. Boolean indicating Include/Exclude array
 * elements
 */
public class GenericUDFApplyPatternOnList extends GenericUDF {
	...
	public ObjectInspector initialize(ObjectInspector[] arguments)
		...
		ObjectInspector inputArrOI = ObjectInspectorUtils
				.getWritableObjectInspector(arguments[0]);
		...
		if (!(listOI.getListElementObjectInspector() instanceof StringObjectInspector)) {
			throw new UDFArgumentException(
					"first argument must be a list of type string");
		}
	...
	public Object evaluate(DeferredObject[] arguments) throws HiveException {
		...
		String pattern = (String) ObjectInspectorUtils
				.copyToStandardJavaObject(
						arguments[1].get(),
						PrimitiveObjectInspectorFactory.javaStringObjectInspector);
		String replaceRegex = (String) ObjectInspectorUtils
				.copyToStandardJavaObject(
						arguments[2].get(),
						PrimitiveObjectInspectorFactory.javaStringObjectInspector);
		Boolean includeSourceArrayInOutput = (Boolean) ObjectInspectorUtils
				.copyToStandardJavaObject(
						arguments[3].get(),
		...
		for (Text s : list) {
			...
			if (str.matches(pattern)) {
				patternMatchSet.add(new Text(str.replaceAll(pattern,
						replaceRegex)));
			}
		}
	...
	public String getDisplayString(String[] children) {
		...
		return "applyPattern(" + children[0] + ", " + children[1] + ", "
