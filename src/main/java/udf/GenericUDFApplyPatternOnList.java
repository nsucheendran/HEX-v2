...
/**
 * GenericUDFPattern. 1. Array to be worked on 2. Pattern to be applied to each array element 3. Replace pattern 4. Boolean indicating
...
public class GenericUDFApplyPatternOnList extends GenericUDF {
  ...
  public ObjectInspector initialize(ObjectInspector[] arguments) throws UDFArgumentException {
    if (arguments.length != 4) {
      throw new UDFArgumentLengthException("The function applyPattern(array, regexPattern, replacePattern, includeSourceArrayInOutput) "
