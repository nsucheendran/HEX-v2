...
public class SegmentationDriverArgs implements ValidatingBean {
  ...
  @Parameter(names = { HexConstants.SEGMENTATION_INPUT_FILE_PATH }, description = "Report Table Name count for the Aggregation step", required = true)
