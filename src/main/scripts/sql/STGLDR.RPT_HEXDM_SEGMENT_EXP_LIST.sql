...
CREATE TABLE STGLDR.RPT_HEXDM_SEGMENT_EXP_LIST
 ...
 COMPRESS YES;
  ...
  GRANT DELETE,INSERT,SELECT,UPDATE ON STGLDR.RPT_HEXDM_SEGMENT_EXP_LIST TO ROLE ORETLRW;
  GRANT SELECT ON STGLDR.RPT_HEXDM_SEGMENT_EXP_LIST TO ROLE ORETLR;
