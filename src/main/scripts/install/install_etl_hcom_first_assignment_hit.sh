...
FAH_DB='hwwdev'
JOB_QUEUE='edwdev'
REPROCESS_BOOKMARK_START_DT='2013-05-01 00'
REPROCESS_BOOKMARK_END_DT='2013-08-31 23'
...
if [ -z "$FAH_PROCESS_ID" ]; then
    ...
    `_WRITE_PROCESS_CONTEXT $FAH_PROCESS_ID "REPROCESS_BOOKMARK_START_DT" "$REPROCESS_BOOKMARK_START_DT"`
    `_WRITE_PROCESS_CONTEXT $FAH_PROCESS_ID "REPROCESS_BOOKMARK_END_DT" "$REPROCESS_BOOKMARK_END_DT"`
