                                                         ...
                                                         from (
                                                                      select /*+ MAPJOIN(pvc_rep) */ cid,
                                                                             ...
                                                                             split(firstValueNSort(concat_ws("~~~", 
                                                                                                                  ...
                                                                                                                  all_mktg_seo_30_day_direct,
                                                                                                                  entry_page_name,
                                                                                                                  cast(supplier_property_id as string)), gmt),"~~~") as min_hit_data 
                                                                             from (          
                                                                                     select guid,
                                                                                            cid,
                                                                                            local_date,
                                                                                            gmt,
                                                                                            parent_variant_code as experiment_variant_code,
                                                                                            new_visitor_ind,
                                                                                            page_assigned_entry_page_name, 
                                                                                            site_sectn_name,
                                                                                            user_cntext_name,
                                                                             ...
                                                                             inner join 
                                                                                  (          
                                                                                     ...
                                                                                     where (last_updated_dt>='${hiveconf:min_src_bookmark}'
                                                                                           ...
                                                                                           and variant_code like '%\\%'
                                                                                 ) pvc_rep
                                                                             on first_hits_pvc.experiment_variant_code=pvc_rep.variant_code
                                                                             where first_hits_pvc.local_date>=pvc_rep.report_start_date
                                                                                   and first_hits_pvc.local_date<=pvc_rep.report_end_date
                                                                             group by guid, cid, variant_code,experiment_code,
                                                                                      version_number, report_start_date, report_end_date, 
                                                                                      last_updated_dt, trans_date  
                                                               ) pvc_hits_by_report
                                                   ) hits_by_report_union
                                    ) hits_by_report
