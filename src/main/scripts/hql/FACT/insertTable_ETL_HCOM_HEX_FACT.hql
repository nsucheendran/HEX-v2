...
insert overwrite table hwwdev.ETL_HCOM_HEX_FACT partition(variant_code, experiment_code, version_number)
    ...
    (
        ...
        case when max(num_active_itin)>0 then 1 else 0 end as active_purchaser, 
