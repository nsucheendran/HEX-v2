...
import com.expedia.edw.hww.hex.etl.aggregation.JobConfigurator;
import com.expedia.edw.hww.hex.etl.aggregation.R4Mapper;
import com.expedia.edw.hww.hex.etl.aggregation.R4Reducer;
...
public class R4MapReduceTest {
  ...
  public void mapperAllJoins() throws IOException {
    ...
    // rf1\trf2\trf3\trf4
    jobConfigurator.stripe("id1" + Constants.COL_DELIM + "val2" + Constants.COL_DELIM + "val3" + Constants.COL_DELIM
        + "val4", data);
  ...
  public void reducer() throws IOException {
    ...
    reduceDriver.withInput(
        ...
        Arrays.asList(new TextMultiple("guid1", "itin1", "2013-01-01", "1", "240", "2", "242", "2", "30"),
            new TextMultiple("guid1", "itin1", "2013-01-02", "1", "240", "2", "242", "2", "30"), new TextMultiple(
                "guid2", "itin2", "2013-01-02", "1", "140", "3", "142", "3", "20"), new TextMultiple("guid2", "itin2",
                "2013-01-03", "-1", "140", "3", "142", "3", "20"), new TextMultiple("guid2", "itin3", "2013-01-04",
                "-1", "140", "3", "142", "3", "20"), new TextMultiple("guid2", "itin4", "2013-01-04", "1", "140", "3",
                "142", "3", "20"), new TextMultiple("guid2", "itin5", "2013-01-05", "1", "140", "3", "142", "3", "20"),
            new TextMultiple("guid3", "itin6", "2013-01-02", "-1", "140", "3", "142", "3", "20"), new TextMultiple(
                "guid4", "itin7", "2013-01-02", "1", "140", "3", "142", "3", "20"), new TextMultiple("guid4", "itin7",
                "2013-01-05", "-1", "-140", "3", "-142", "3", "-20"))).withOutput(
        bw,
        text(Constants.COL_DELIM, "4", "3", "3", "2", "2", "4", "2", "1320.0", "28", "1336.0", "28", "180.0", "1",
            "key1", "key2", "key4", "key5", "key3"));
    reduceDriver.runTest();

    reduceDriver
        .withInput(new TextMultiple("key1", "key2", "key3_1", "key4_1", "key5"),
            Arrays.asList(new TextMultiple("guid1", "itin81", "2013-01-01", "1", "240", "2", "242", "2", "30")))
        .withOutput(
            bw,
            text(Constants.COL_DELIM, "1", "1", "0", "1", "0", "0", "1", "240.0", "2", "242.0", "2", "30.0", "0",
