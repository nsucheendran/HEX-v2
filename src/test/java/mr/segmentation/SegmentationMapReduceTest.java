...
public class SegmentationMapReduceTest {
  ...
  public void mapper() throws IOException {
    ...
    mapDriver.withInput(bw, text(text, sb, Constants.COL_DELIM, "id1", "val", "val1", "7"));
    sb.setLength(0);
    mapDriver.withInput(bw, text(text, sb, Constants.COL_DELIM, "id1", "val", "val4", "8"));
    sb.setLength(0);
    mapDriver.withInput(bw, text(text, sb, Constants.COL_DELIM, "id2", "val", "val1", "9"));

    mapDriver.withOutput(new TextMultiple("1", "test1", "id1", "val", "Unknown"), new TextMultiple("7"));
